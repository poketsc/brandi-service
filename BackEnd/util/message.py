...
INSERT_ORDER_INFORMATION_ERROR = '주문 정보 입력에 실패 했습니다.'
INSERT_ORDER_HISTORY_INFORMATION_ERROR = '주문 정보 히스토리 입력에 실패 했습니다.'
CART_ID_TYPE_ERROR = 'cart_id 가 int 타입이 아닙니다.'
PRODUCT_ID_TYPE_ERROR = 'product_id 가 int 타입이 아닙니다.'
PRODUCT_OPTION_ID_TYPE_ERROR = 'product_option_id 가 int 타입이 아닙니다.'
